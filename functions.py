...
def softmax(x):
    ...
    sft = e/e.sum(axis=0, keepdims=True)
...
def linear_activation_backward(dA, cache, activation, dZ):
    """
...
def L_model_backward(AL, Y, caches):
    ...
    grads["dA" + str(L-1)], grads["dW" + str(L)], grads["db" + str(L)] = \
        linear_activation_backward(dAL, current_cache, "softmax", dZ)
    ### END CODE HERE ###
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp, dW_temp, db_temp = \
            linear_activation_backward(
                grads["dA" + str(l+1)], current_cache, "relu", dZ)
